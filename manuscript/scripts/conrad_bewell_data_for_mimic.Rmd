...
saveRDS(all_mod_res, file = "../../data/derived/glm_binomial_model.RData")
```
...
ggsave("../../exploratory/figures/effect-size_logistical-regression.png")
```
...
ggsave("../../exploratory/figures/ACC22_effect-size_glm-binomial.png",
       height = 4, width = 7)
```
...
ggsave("../../exploratory/figures/ACC22_effect-size_volcano-plot.png",
       height = 4, width = 7)
```
