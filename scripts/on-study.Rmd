...
xs <- 
  ...
  rename("Repeat V1" = "Redoing V1",
         "Repeat V3" = "Redoing V3") %>%
...
xd %>%
  ...
  geom_vline(xintercept = as.POSIXct(max(xs$`Visit 1`, na.rm = TRUE) +
                                       lubridate::weeks(10)), 
             color = "blue", linetype = "dotted") +
  ggsave("../figures/on-study.png", height = 3, width = 5)

as.POSIXct(max(xs$`Visit 1`, na.rm = TRUE) + lubridate::weeks(10))

max(xs$`Visit 1`, na.rm = TRUE)
```
